...
const renderSocialNetwork = () => {
    return (
        <div className={styles.socialNetwork}>
            <Link href={"https://www.instagram.com/cefetmg/"}>
                <a title="Instagram">
                    <img
            ...
            <Link
                href={
                    "https://www.linkedin.com/school/centro-federal-de-educa%C3%A7%C3%A3o-tecnol%C3%B3gica-de-minas-gerais/mycompany/"
                }
            >
                <a title="LinkedIn">
                    <img
            ...
            <Link href={"https://www.facebook.com/cefetmg"}>
                <a title="Facebook">
                    <img
                        className={styles.socialNetworkIcons}
            ...
            <Link href={"https://twitter.com/cefet_mg"}>
                <a title="Twitter">
                    <img
                        className={styles.socialNetworkIcons}
